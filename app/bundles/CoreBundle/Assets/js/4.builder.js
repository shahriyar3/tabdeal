...
Mautic.launchBuilder = function (formName, actionName) {
    ...
    var overlay = mQuery('<div id="builder-overlay" class="modal-backdrop fade in"><div style="position: absolute; top:' + spinnerTop + 'px; left:' + spinnerLeft + 'px" class="builder-spinner"><i class="ri-loader-3-line fa-spin fa-5x"></i></div></div>').css(builderCss).appendTo('.builder-content');
