                ...
                success: function (response) {
                    if (response.redirect) {
                        ...
                        if (response.success) {
                            ...
                            mQuery('#updateTable tbody').append('<tr><td>' + response.nextStep + '</td><td id="update-step-downloading-status"><span class="hidden-xs">' + response.nextStepStatus + '</span><i class="pull-right ri-loader-3-line fa-spin"></i></td></tr>');
                            Mautic.processUpdate(container, step + 1, state);
                        } else {
                ...
                success: function (response) {
                    if (response.redirect) {
                        ...
                        if (response.success) {
                            ...
                            mQuery('#updateTable tbody').append('<tr><td>' + response.nextStep + '</td><td id="update-step-extracting-status"><span class="hidden-xs">' + response.nextStepStatus + '</span><i class="pull-right ri-loader-3-line fa-spin"></i></td></tr>');
                            Mautic.processUpdate(container, step + 1, state);
                        } else {
                ...
                success: function (response) {
                    if (response.redirect) {
                        ...
                        if (response.success) {
                            ...
                            mQuery('#updateTable tbody').append('<tr><td>' + response.nextStep + '</td><td id="update-step-moving-status"><span class="hidden-xs">' + response.nextStepStatus + '</span><i class="pull-right ri-loader-3-line fa-spin"></i></td></tr>');
                            Mautic.processUpdate(container, step + 1, state);
                        } else {
                ...
                success: function (response) {
                    if (response.redirect) {
                        ...
                        if (response.error) {
                            ...
                            // If complete then we go into the next step
                            mQuery('#updateTable tbody').append('<tr><td>' + response.nextStep + '</td><td id="update-step-cache-status"><span class="hidden-xs">' + response.nextStepStatus + '</span><i class="pull-right ri-loader-3-line fa-spin"></i></td></tr>');
                            Mautic.processUpdate(container, step + 1, response.updateState);
                        } else {
                            // In this section, the step hasn't completed yet so we repeat it
                            mQuery('td[id=update-step-moving-status]').append(mQuery('<i></i>').addClass('pull-right ri-loader-3-line ri-spin'));
                ...
                success: function (response) {
                    if (response.redirect) {
                        ...
                        if (response.error) {
                            ...
                            // If complete then we go into the next step
                            mQuery('#updateTable tbody').append('<tr><td>' + response.nextStep + '</td><td id="update-step-database-status"><span class="hidden-xs">' + response.nextStepStatus + '</span><i class="pull-right ri-loader-3-line fa-spin"></i></td></tr>');
                            Mautic.processUpdate(container, step + 1, response.updateState);
                        } else {
                ...
                success: function (response) {
                    if (response.redirect) {
                        ...
                        if (response.success) {
                            ...
                            // If complete then we go into the next step
                            mQuery('#updateTable tbody').append('<tr><td>' + response.nextStep + '</td><td id="update-step-finalization-status"><span class="hidden-xs">' + response.nextStepStatus + '</span><i class="pull-right ri-loader-3-line fa-spin"></i></td></tr>');
                            Mautic.processUpdate(container, step + 1, state);
                        } else {
